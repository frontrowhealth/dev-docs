...
**Overview**: Our product allows you to showcase a dynamic widget that highlights the clinicians who have shared your product. This feature builds trust, enhances credibility, and empowers users to make confident, informed decisions when choosing health and wellness products.

Whether you’re implementing this on a Shopify store or a custom platform, this guide will walk you through the necessary steps and resources to seamlessly integrate these features.

## Current offerings

**Quantitative data:** highlights the number of clinicians sharing your product(s) with their patients

Example: ADD GIF HERE

**Qualitative data:** clinicans write reviews about specific products that brands can feature on their sites.
